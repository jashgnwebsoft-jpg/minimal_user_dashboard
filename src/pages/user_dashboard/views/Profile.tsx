    ...
    <Card sx={{ borderRadius: 5 }}>
      ...
      <Stack spacing={2} sx={{ p: 3, typography: "h6" }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          <Typography>
            Live at
            <Link variant="h6" color="inherit" sx={{ textDecoration: "none" }}>
              &nbsp; United Kingdom
            </Link>
          </Typography>
        </Box>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          <Icon icon="material-symbols:business-center-rounded" width="24" />
          <Typography>
            CTO at
            <Link variant="h6" color="inherit" sx={{ textDecoration: "none" }}>
    ...
    <Card sx={{ borderRadius: 5 }}>
      ...
      <Stack spacing={2} sx={{ p: 2 }}>
        ...
        >
          ...
          <Link color="inherit">https://www.linkedin.com/in/frankie</Link>
        </Box>
        <Box
          sx={{
            gap: 1,
    ...
    <Card sx={{ p: 3, borderRadius: 5 }}>
      ...
      >
        <Stack direction="row" gap={1}>
          <Chip
            avatar={
              <Icon icon="solar:gallery-wide-bold" width={24} color="#22C55E" />
            }
            label="Image / Video"
          />
          <Chip
